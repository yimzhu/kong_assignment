...
class GatewayServicePage {
    ...
    */
    ...
    createNewGatewayByProtocol(protocol, host, path, port){
        cy.get("[data-testid='toolbar-add-gateway-service']").should('not.have.value', 'oldvalue').click();
        cy.get("[data-testid='gateway-service-protocol-radio']").should('not.have.value', 'oldvalue').click();
